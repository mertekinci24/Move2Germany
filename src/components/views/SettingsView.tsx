...
import { exportUserData, downloadUserDataAsJSON } from '../../lib/export';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Once you delete your account, there is no going back. All your data will be permanently deleted from our servers.
        </p>
        <button
