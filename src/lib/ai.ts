...
async function executeTool(toolName: string, argsStr: string, context: AiContext): Promise<any> {
...
async function listTasksTool(args: any, context: AiContext): Promise<any> {
...
async function explainTaskTool(args: any, context: AiContext): Promise<any> {
...
async function updateTaskStatusTool(args: any, context: AiContext): Promise<any> {
...
async function openContentTool(args: any): Promise<any> {
